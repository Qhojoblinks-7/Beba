...
export const CustomerHeader = ({ name, orderId }) => (
  <View style={styles.customerCard}>
    <View style={{ flex: 1 }}>
      ...
      <BebaText category="body3" color={Palette.textSecondary}>{orderId}</BebaText>
    </View>
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: Palette.background, justifyContent: 'center', alignItems: 'center', marginLeft: 10 }
});
